...
int main() {
    ...
    /*
    good conceptual start, but things to imrpove:
        ==> need a cleaner way to detect 32nd sample
        ==> need a cleaner way to handle first frame
        ==> need to handle partial frames
        ==> frame id should start from 0 technically
